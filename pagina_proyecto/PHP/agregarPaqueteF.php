...
<body>
    ...
    <div class="container-add">
        ...
        <h2 class="container__title">Registrar paquete</h2>
            <form action="../PHP/agregarPaqueteF.php" method="post" class="container__form">
            <div class="form-row">
            ...
            <div class="form-row">
                ...
                <a href="gestion_paquetesF.php" class="registrar"><input type="submit" value="Registrar" class="container__submit"></a>
            </form>
        </div>
</body>
</html>
...
if(isset($_POST['cliente']) && isset($_POST['destino']) && isset($_POST['fecha']) && isset($_POST['lote']) && isset($_POST['estado']) && isset($_POST['peso']) && isset($_POST['tipo'])){
